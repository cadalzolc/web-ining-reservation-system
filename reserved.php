					...
					<div class="row">
						...
						<div class="col-md-3">
							<div class="panel panel-info">
								<div class="panel-heading">
									<h3 class="panel-title">2. AMENITY</h3>
								</div>
								<div class="panel-body">
									AMENITY TYPE
								</div>
				...
				<div class="panel-body">
					...
					<div class="container-fluid" style="text-align: center;">
					  ...
					  <div class="form-group">
					    ...
					    <select class="btn btn-default" id="orig-id" style="width: 340px;">
					  ...
					  <div class="form-group">
					    ...
					    <select class="btn btn-default" id="dest-id" style="width: 337px;">
					  ...
					  <div class="form-group">
					    ...
					    <input type="date" class="btn btn-default" id="dept-date" style="width: 317px;">
					  </div>
