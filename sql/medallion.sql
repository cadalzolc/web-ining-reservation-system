...
INSERT INTO `client` (`client_id`, `fullname`, `address`, `contact`, `age`, `gender`, `username`, `password`) VALUES
(29, 'Renato J. Solitarios Jr.', 'Bgy. Cogon Calbayog City', '09977889323', '20', 'Male', 'renato', '123');
...
--
ALTER TABLE `client`
  MODIFY `client_id` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
